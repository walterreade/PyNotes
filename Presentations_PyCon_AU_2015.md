 ...
 * Bit of a black box compared to PyMC3
* pyMC3
 * Various optimizers
* Generally good idea to start building models with dummy data and confirm you get expected results.
* With Bayesian modeling, because you specificy a model, it is less prone to over-fitting.

### [Recreating the Pycon 2015 site in under 30 minutes](https://www.youtube.com/watch?v=05GKqTZGRXU)
* By: Tim Heap
* 

### [PostgreSQL in Django 1.8](https://www.youtube.com/watch?v=aSRk0L6D3Zs)
* By: Christophe Pettus
* 

### [Practical Federated Identity](https://www.youtube.com/watch?v=YYzJdxI_g6g)
* By: Jamie Lennox
* 

### [Adventures in pip land](https://www.youtube.com/watch?v=tqVWzndh374)
* By: Robert Collins
* 
...
### [Fang: Pythonic dependency injection](https://www.youtube.com/watch?v=zqRd941NXlI)
* By: Nathan Craike
* 

### [Python's Transition to Multilingual Programming](https://www.youtube.com/watch?v=TeZZ9q8pqjQ)
* By: Nick Coghlan
* 

### [What Django can learn from Twisted](https://www.youtube.com/watch?v=_HZR7_ZBkYY)
* By: Amber "Hawkie" Brown
* 

### [Moby and the Beanstalk](https://www.youtube.com/watch?v=LPfMlOBB5VQ)
* By: Sebastian Vetter
* 

### [Breaking backwards compatibility: The easy way!](https://www.youtube.com/watch?v=VZp7iWOKJ_A)
* By: Flavio Percoco
* 

### [Python's New Type Hints in Action… In JavaScript](https://www.youtube.com/watch?v=_PPQLeimyOM)
* By: Christopher Neugebauer
* 

### [An End-to-End Machine Learning Ecosystem in a Quarter ](https://www.youtube.com/watch?v=of6pHdSbtOM)
* By: Chris Hausler
* 

### [Sprinting For Beginners](https://www.youtube.com/watch?v=6NUBO1DDQAY)
* By: Tennessee Leeuwenburg
* 

### [Conda: a cross-platform, python-agnostic binary package manager](https://www.youtube.com/watch?v=Fqknoni5aX0)
* By: Lex Hider
* 

### [Ansible, Simplicity, and the Zen of Python](https://www.youtube.com/watch?v=JlrkizEBjXk)
* By: Todd Owen
* 

### [Predicting sports winners using data analytics with pandas and scikit-learn](https://www.youtube.com/watch?v=k7hSD_-gWMw)
* By: Robert Layton
* 

### [Stop and smell the Djangos](https://www.youtube.com/watch?v=tl0wkY78jk4)
* By: Richard Shea
* 

### [The one true way of doing Django deployments](https://www.youtube.com/watch?v=1ABPQyANid0)
* By: Tom Eastman
* 

### [Many-to-many, minus the middleman](https://www.youtube.com/watch?v=lNh-tS8i-J4)
* By: Alex Hill
* 

### [Rapid prototyping with teenagers](https://www.youtube.com/watch?v=gOnnjPQzXg8)
* By: Katie Bell
* 

### [Easy wins with Cython: fast and multi-core](https://www.youtube.com/watch?v=NfnMJMkhDoQ)
* By: Caleb Hattingh
* 

### [Journey to becoming a Developer: an Administrators story](https://www.youtube.com/watch?v=3pphvUMy4Fs)
* By: Victor Palma
* 

### [Python on the move: The state of mobile Python](https://www.youtube.com/watch?v=Cbkcr3ofBmk)
* By: Russell Keith-Magee
* 

### [How Composition Can Help You Write Modular, Testable Code](https://www.youtube.com/watch?v=kUIjaHPvaTo)
* By: 
* 

### [Inviting Code](https://www.youtube.com/watch?v=mByG_51ZWiQ)
* By: Capel Brunker
* 

### [On Being Pythonic](https://www.youtube.com/watch?v=R4AeB85gEeU)
* By: Peter Lovett
* 

### [Realtime websites with Django and Meteor](https://www.youtube.com/watch?v=N9OvbRP5W0g)
* By: Tyson Clugg
* 

### [Arrested Development](https://www.youtube.com/watch?v=H0KReHUawHI)
* By: Scott Triglia
* 

### [Lrparsing, when regular expressions aren't enough](https://www.youtube.com/watch?v=9PQsCmOeYwU)
* By: 
* 

### [Government dashboards and open data](https://www.youtube.com/watch?v=zn7N_F09q6U)
* By: Paul Haesler
* 

### [Docker + Python](https://www.youtube.com/watch?v=Fxsq3BciYdo)
* By: Tim Butler
* 

### [Four* non-cryptographic hash functions enter. One leaves.](https://www.youtube.com/watch?v=IdVX4qHJXEY)
* By: Adam Harvey
* 
...
### [MidoNet: networking made easy](https://www.youtube.com/watch?v=YienqSky-c0)
* By: Pino de Candia
* 

### [Test-Driven Repair](https://www.youtube.com/watch?v=1i5leCslA4g)
* By: Christopher Neugebauer
* 
...
### [Talking to Browsers with CORS](https://www.youtube.com/watch?v=a9ze1XilXSI)
* By: Michael Krotscheck
* 

### [Trials & tribulations teaching Python at CoderDojo](https://www.youtube.com/watch?v=Wlw6SXSb5eU)
* By: Caleb Hattingh
* 

### [OpenStack Works, so now what?](https://www.youtube.com/watch?v=G971S1UT0Kw)
* By: Monty Taylor
* 

### [Writing Python For Kids](https://www.youtube.com/watch?v=lWyJ_HXGsm0)
* By: Brendan Scott
* 

### [Spreadsheet-Driven Meta-Programming for Python](https://www.youtube.com/watch?v=DmLHqOvbG9M)
* By: Javier Candeira
* 
